      ...
      <div className="container mx-auto px-4">
        ...
        <div className={`grid gap-8 ${gridCols}`}>
          {data.map(({ id, icon, title, description }) => (
            <div
              key={id}
              className="flex min-h-[160px] flex-col items-start rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:border-gray-300"
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-50 border border-blue-100">
